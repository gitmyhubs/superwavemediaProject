    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          ...
          <p><b>Good Design leads to extraordinary exploring business which makes the web A BETTER PLACE.</b></p>
        </header>
        ...
        <div class="row about-cols">
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              ...
              <p>
             <b> We just don't build website's We build Website that attracts and promotes.</b>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="img/ui-design.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="ion-ios-list-outline"></i></div>
              </div>
              <h2 class="title">UI Design</h2>
              <p>
                <b>We believe creativity without strategy is art and creativity with Strategy is Design.</b>
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="img/av-solution.jpg" alt="" class="img-fluid">
           ...
           <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="img/motion-graphics.png" alt="" class="img-fluid">
                <div class="icon"><i class="ion-ios-eye-outline"></i></div>
              </div>
              <h2 class="title">Our Goals</h2>
              <p>
