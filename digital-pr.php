   ...
   <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>Digital - PR</h3>
          <p>We are award winning digial PR-company in East India, having creative approach ,processes & framework to manages brand images.
            <br>
            Digital PR is a way to create brand perception using content Marketing via various digital, Social Media & Smart-phone platform.
            It is also a public relation for new Generation having a amalgation for Marketing and PR.
           ...
           <header class="section-header">
            <h3>Our Digital PR Framework</h3>
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              ...
              <p>
             <b> Create a benchmark of content Strategies that can work for brand.</b>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              ...
              <h2 class="title">Identify</h2>
              <p>
                <b>Influence your brand and target different users.</b>
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              ...
              <h2 class="title">Segmentation</h2>
              <p>
             <b>Filtration for real-time traffic among users.</b>
              </p>
            </div>
          </div>
           ...
           <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              ...
              <h2 class="title">Involve</h2>
              <p>
             <b>Engage user to offer wide range of benefits to create mutually beneficial relationships.</b>
              </p>
            </div>
          </div>
           ...
           <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              ...
              <p>
             <b>With the help of our real-time reports you will able to figure-out your influences in order to ensure them next-time.</b>
              </p>
            </div>
          </div>
            ...
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Insights</h4>
                  <p style="color: #fff;">Create a benchmark of content Strategies that can work for brand.</p>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Segmentation</h4>
                   <p style="color: #fff;">Filtration for real-time traffic among users.</p>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Involve</h4>
                  <p style="color: #fff;">Engage user to offer wide range of benefits to create mutually beneficial relationships.</p>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Measure</h4>
                   <p style="color: #fff;">With the help of our real time reports you will able to figure out your influencers in order to insure them next time.</p>
                  <!-<span>dolor</span>-->
                  <!--<div class="social">
                    <a href=""><i class="fa fa-twitter"></i></a>
                    <a href=""><i class="fa fa-facebook"></i></a>
