    ...
    <section id="team">
      <div class="container">
        <div class="section-header wow fadeInUp">
          <h3>CASE STUDY</h3>
          <p><b>We Believe Action and Passion is the Foundational key to all Success.</b></p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp">
            <div class="member">
              <img src="img/digital india.png" class="img-fluid" alt="">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="member">
              <img src="img/development.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="member">
              <img src="img/employment.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum</h4>
                  <span>sit emet</span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="member">
              <img src="img/digital marketing.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum</h4>
                  <span>sit emet</span>
         ...
         <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp">
            <div class="member">
              <img src="img/flop.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum</h4>
                  <span>sit emet dolor</span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="member">
              <img src="img/manpower.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum sit</h4>
                  <span>emet dolor</span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="member">
              <img src="img/hit2.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum</h4>
                  <span>sit emet</span>
         ...
         <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp">
            <div class="member">
              <img src="img/sustain.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum</h4>
                  <span>sit emet dolor</span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="member">
              <img src="img/fmcg.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum sit</h4>
                  <span>emet dolor</span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="member">
              <img src="img/telecommunications.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum</h4>
                  <span>sit emet</span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="member">
              <img src="img/technology execution.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Lorem ipsum</h4>
                  <span>sit emet</span>
