...
<head>
  <meta charset="utf-8">
  <title>Industry Research & Insight</title>
    ...
    ============================-->
      ...
      <div class="container">
        ...
        <header class="section-header">
          ...
          data in a best possible manner that clients can understand and execute.
          
            Superwave media helps  companies, agencies and organisations creating value through data collection , research and analysis.
          ...
          The Research Insights an obligated organization and a global groundbreaker in research, analytics and advisory. We create advance informative reports that will assist you to transform your business, amend your approach and take decisions valiantly. The analysts of Research Insights provides the clients’ with accurate market statistics along with vogue and cutting-edge industry reports, which gives comprehensive information on the pre-eminent and niche company profiles  Keeping in mind the clients’ needs, we make sense of downsides, prospects, conditions and valuations by using our substantiated methodologies and skills for our patrons to experience the innovative solutions and outcomes.
        </header>
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              ...
              <h2 class="title">Problem Diagnosis</h2>
              <p>
             <b> We analyze business challenges and priortize where to focus research to maximize time and budget.</b>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              ...
              <p>
                <b>Gain and indepth understanding of customers and product not possible via data analysis alone.</b>
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              ...
              <h2 class="title">Action Planning</h2>
              <p>
             <b>
             Ensure insights and have the most actionable impact by prepairing teams to immediately use the insights.</b>
              </p>
            </div>
          </div>
