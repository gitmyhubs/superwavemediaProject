...
<head>
  <meta charset="utf-8">
  <title>Smart Phone Campaign</title>
    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="we-offer.php">We Offer</a></li>
          <li><a href="be-more-with-us.php">Be More With Us</a></li>
       <li class="menu-active"><a href="smart-phone-campaign.php">Digital Transformation</a></li>
        </ul>
    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          <h3>SMART PHONE CAMPAIGN</h3>
          <p>Mobile marketing would make a great part of any marketing strategy if your campaign’s goal is to build brand awareness. Mobile-friendly platforms like social media apps make it easy for consumers to engage with brands, whether they’re liking, commenting, or sharing, making them great areas to launch brand awareness campaigns.
          Here are a few strategies that you can use to build brand awareness using mobile.</p>
        </header>
