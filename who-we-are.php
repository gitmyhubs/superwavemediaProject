  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="who-we-are.php">Who We Are</a></li>
          <li><a href="we-offer.php">We Offer</a></li>
          <li><a href="be-more-with-us.php">Be More With Us</a></li>
       <li><a href="smart-phone-campaign.php">Digital Transformation</a></li>
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              ...
              <p>
              We want to earn and be worthy of our customer’s trust and to create pragmatic moment and word of mouth around the globe.
              </p>
            </div>
          </div>
